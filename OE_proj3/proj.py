...
def decodeInd(invidual):
    var1 = int("".join(map(str, invidual.genome[:20])), 2)
    var2 = int("".join(map(str, invidual.genome[20:])), 2)
    return var1, var2
...
if __name__ == "__main__":
    ...
    # TODO sprawdzic dokumentacje
    toolbox.register("select", tools.selRandom, 3)

    # TODO sprawdzic dokumentacje
    toolbox.register("select", tools.selBest, 3)

    # TODO sprawdzic dokumentacje
    toolbox.register("select", tools.selWorst, 3)

    # TODO sprawdzic dokumentacje
    toolbox.register("select", tools.selRoulette, 3)
