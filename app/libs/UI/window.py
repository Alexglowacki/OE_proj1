...
class Window(tk.Tk):
    ...
    def open(self):
        Calculations.run_calculations(
            ...
            elite_strategy=int(config.get('entries', 'elite strategy percent')),
            variable_number=int(config.get('entries', 'variable number')),
            cross_probability=int(config.get('entries', 'cross probability')),
            mutation_probability=int(config.get('entries', 'mutation probability')),
            inversion_probability=int(config.get('entries', 'inversion probability')),
